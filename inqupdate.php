...
if(isset($_POST["submit"]))
{
  ...
  $sql= "UPDATE buyerinquiry SET id='$ID',FullName='$FullName',Email='$Email',ContactNo='$ContactNo',Address='$Address',Distric='$Distric', Price= '$Price', LandDetails= '$LandDetails'where id=$ID";
